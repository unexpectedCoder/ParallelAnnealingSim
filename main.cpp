...
int main(int argc, char *argv[])
{
  ...
  // Optimization
  Optimizer optimizer(rozen, dim, bnds, opt, nThreads);

  QObject::connect(&optimizer, &Optimizer::resultsReady, &optimizer, &Optimizer::showResults);
  QObject::connect(&optimizer, &Optimizer::resultsReady, &optimizer, &Optimizer::showBestResut);
  QObject::connect(&optimizer, &Optimizer::completed, &app, &QCoreApplication::quit);
